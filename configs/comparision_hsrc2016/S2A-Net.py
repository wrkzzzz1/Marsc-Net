...
data = dict(
    ...
    val=dict(
        ...
        classwise=True,
        version='le90'))
train_loop = dict(type='EpochBasedTrainLoop', max_epochs=90, val_interval=1)
...
log_level = 'INFO'
resume_from = '/root/mmdetection/work_dirs/S2A-Net/epoch_70.pth'
load_from = None
workflow = [('train', 1)]
...
model = dict(
    ...
    test_cfg=dict(
        ...
        max_per_img=300))
work_dir = '/root/mmdetection/work_dirs/S2A-Net'
auto_resume = False
gpu_ids = range(0, 1)
seed = 4
deterministic = True
