...
data = dict(
    ...
    val=dict(
        ...
        classwise=True,
        version='le90'))
train_loop = dict(type='EpochBasedTrainLoop', max_epochs=60, val_interval=1)
...
log_level = 'INFO'
resume_from = '/root/mmdetection/work_dirs/rotated_faster_rcnn/epoch_40.pth'
load_from = None
workflow = [('train', 1)]
...
model = dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=300)))
work_dir = '/root/mmdetection/work_dirs/rotated_faster_rcnn'
auto_resume = False
gpu_ids = range(0, 1)
seed = 4
deterministic = True
