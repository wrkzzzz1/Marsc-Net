...
train_pipeline = [
    ...
    dict(type='RandomRotate', prob=0.5, angle_range=180, version=angle_version),
...
log_level = 'INFO'
work_dir = './work_dirs/roi_trans_r50_fpn_1x_hsrc_le90'
...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=[
            dict(
                ...
                roi_feat_size=7,
                num_classes=len(classes),  # ★ 这里改成31
                bbox_coder=dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            min_bbox_size=0,
            score_thr=0.05,
            nms=dict(type='nms', iou_thr=0.1),  # ★ 修正这里
            max_per_img=2000))
)
