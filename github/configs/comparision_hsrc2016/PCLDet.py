...
data = dict(
    ...
    val=dict(
        ...
        classwise=True,
        version='le90'))
train_loop = dict(type='EpochBasedTrainLoop', max_epochs=50, val_interval=1)
...
log_level = 'INFO'
load_from = None
resume_from = '/root/mmdetection/work_dirs/PCLDet/epoch_33.pth'
workflow = [('train', 1)]
...
work_dir = '/root/mmdetection/work_dirs/PCLDet'
auto_resume = False
gpu_ids = range(0, 1)
seed = 4
deterministic = True
