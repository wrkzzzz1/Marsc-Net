...
def main():
    ...
    if rank == 0:
        ...
        if args.eval:
            ...
            # args.eval is a list because argparse uses nargs='+'
            # e.g. "--eval mAP" gives args.eval = ['mAP']
            eval_metric = args.eval[0] if isinstance(args.eval, list) and len(args.eval) == 1 else args.eval

            eval_kwargs.update(dict(metric=eval_metric, **kwargs))
